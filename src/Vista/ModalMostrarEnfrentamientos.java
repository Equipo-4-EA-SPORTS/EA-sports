...
public class ModalMostrarEnfrentamientos extends JDialog {
    private JPanel contentPane;
    private JButton buttonOK;
    private JTable tablaJugadores;

    public ModalMostrarEnfrentamientos() {
    ...
    public static void main(String[] args) {
        ModalMostrarEnfrentamientos dialog = new ModalMostrarEnfrentamientos();
